...
# Available models:
# - anthropic.claude-3-5-sonnet-20241022-v2:0  (recommended - works with on-demand)
# - anthropic.claude-3-haiku-20240307-v1:0     (faster, cheaper)
# - anthropic.claude-3-sonnet-20240229-v1:0     (balanced)
# For Nova models, you need to use inference profiles instead of direct model IDs
BEDROCK_MODEL_ID = os.getenv("BEDROCK_MODEL_ID", "meta.llama3-3-70b-instruct-v1:0")
